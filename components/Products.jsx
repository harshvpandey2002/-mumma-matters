            ...
            <div className="product-info">
              ...
              <div style={{ marginTop: '14px' }}>
                <button
                  ...
                  disabled={voted.conceive}
                  style={voted.conceive ? voteButtonVoted : voteButtonBase}
                >
            ...
            <div className="product-info">
              ...
              <div style={{ marginTop: '14px' }}>
                <button
                  ...
                  disabled={voted.nursing}
                  style={voted.nursing ? voteButtonVoted : voteButtonBase}
                >
            ...
            <div className="product-info">
              ...
              <div style={{ marginTop: '14px' }}>
                <button
                  ...
                  disabled={voted.rebuild}
                  style={voted.rebuild ? voteButtonVoted : voteButtonBase}
                >
